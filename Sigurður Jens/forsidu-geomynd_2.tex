...
\draw [name path=axis_1-2, mainline] \lline{P_1-2}{Q_1-2};
\draw [name path=axis_2-3, mainline] \lline{P_2-3}{Q_2-3};
\draw [name path=axis_3-1, mainline] \lline{P_3-1}{Q_3-1};
